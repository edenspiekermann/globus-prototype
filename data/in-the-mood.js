        ...
        blocks: [
          {
            title: {
              align: 'center',
              label:
                'Navajo-Motive, Blumen-stickereien und dazu eine gehörige Portion rockige Nonchalance — unbegrenzte Möglichkeiten.',
              size: 'medium'
            }
          }
        ]
...

      {
        ...
        blocks: [
...

          {
            content: {
              content: [
                'Der Stoff, aus dem Wüstenträume sind — auch in den eigenen vier Wänden. Rattan-Lampen sind der Interior-Trend der Saison. Extraweiches Licht für milde Sommerabende, in Größen bis zum 50 cm Umfang. Texmex-Style, grenzenlos.'
              ]
            },
    ...
    sections: [
        ...
        blocks: [
          {
            ...
            video: {
              url: '/static/videos/GLOBUS_FOOD_h264.mp4'
            },
...

      {
        ...
        blocks: [
          {
            image: {
              url: '/static/images/in-the-mood/market_vegetables.jpg',
              alt: 'Gemuesestand'
            }
          }
        ]
...

      {
        ...
        blocks: [
          {
            image: {
              url: '/static/images/in-the-mood/market_lemonade.jpg',
              alt: 'Sommer-Bowle'
            },
        ...
        blocks: [
          {
            title: {
              label:
                'Unsere sommerlichen Salate und Häppchen haben wir frisch für Sie zubereitet. Immer frisch bei uns in der ***delicatessa',
              align: 'center',
              size: 'medium'
            }
          }
...

      {
        ...
        blocks: [
          {
            image: {
              url: '/static/images/in-the-mood/market_burgers_01.jpg'
            },
...

      {
        ...
        blocks: [
          {
            image: {
              url: '/static/images/in-the-mood/market_burgers_02.jpg',
              alt: ''
            }
          },
